...
MODEL_DIR = sys.argv[1] if len(sys.argv) > 1 else os.path.join(os.environ.get("SUSHI_MODELS_DIR", os.path.expanduser("~/.sushi/models")), "Qwen3.8-Flash-Next-Sushi-3bpw")
