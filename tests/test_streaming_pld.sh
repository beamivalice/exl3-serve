...
MODEL="${PLD_TEST_MODEL:-/Users/beam/llm/models/Qwen3.8-Flash-Next-EXL3-K3-w12-mcg-plugged}"
...
if [ ! -d "$MODEL" ]; then
    ...
    echo "  at /Users/beam/llm/models/Qwen3.8-Flash-Next-EXL3-K3-w12-mcg-plugged (the default this test"
