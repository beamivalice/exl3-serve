...
RUNS_ROOT="${RUNS_ROOT:-$HOME/.sushi/runs/bench-versions}"
...
# it split a --drafter path into three words and the server refused to boot
# rather than quietly benching without the sidecar.
