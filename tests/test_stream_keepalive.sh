...
#   - KEEPALIVE_TEST_MODEL or ${SUSHI_MODELS_DIR:-$HOME/.sushi/models}/Qwen3.8-Flash-Next-Sushi-3bpw
#
...
MODEL="${KEEPALIVE_TEST_MODEL:-${SUSHI_MODELS_DIR:-$HOME/.sushi/models}/Qwen3.8-Flash-Next-Sushi-3bpw}"
if [ ! -d "$MODEL" ]; then
